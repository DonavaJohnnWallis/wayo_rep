...
//Set a CheckedChange Listener for Switch Button
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.homebutton) {
            ...
            Intent intent = new Intent(ContractTwoActivity.this, MainActivity.class );
        ...
        if (id == R.id.backbutton){
            startActivity(new Intent(this,ContractOneActivity.class));
        }
        if (id == R.id.declineContract){

            Intent intent = new Intent(ContractTwoActivity.this, DeclineContractActivity.class );
