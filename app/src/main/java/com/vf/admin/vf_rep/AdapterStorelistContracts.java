...
public class AdapterStorelistContracts extends ArrayAdapter {
    ...
    public AdapterStorelistContracts(Context context)
    {
        super(context, 0);
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (row == null)
        {
            ...
            imageViewIte.setText("Store URN: 00 000 00");
            url.setText("View Contract");
